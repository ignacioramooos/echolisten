  ...
  return (
    <PageShell navLinks={[{ label: t("about.backHome"), href: "/" }]}>
      ...
      <section className="mt-4">
        <h2 className="font-display text-[28px] leading-tight text-foreground">What is Cor Ad Cor?</h2>
        <p className="font-body text-[13px] text-muted-foreground mt-1 max-w-[600px]">
          Cor Ad Cor is an anonymous, free peer-support platform that connects people who need to talk
      ...
      <section className="mt-4 border-t border-foreground pt-4">
        ...
        <p className="font-body text-[13px] text-muted-foreground mt-1 max-w-[600px]">
          Every Cor Ad Cor Listener completes a rigorous multi-step training program before they can
      ...
      <section className="mt-4 border-t border-foreground pt-4">
        ...
        <p className="font-body text-[13px] text-muted-foreground mt-1 max-w-[600px]">
          Cor Ad Cor is not a crisis service, therapy, or medical support. Listeners are trained
